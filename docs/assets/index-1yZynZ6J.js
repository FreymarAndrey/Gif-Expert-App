  ...
  function E(C, N) {
    ...
    try {
      ...
      if (m !== null) var bt = !0;
        ...
        var yn = t(c);
        yn !== null && yl(h, yn.startTime - N), (bt = !1);
      }
      return bt;
    } finally {
      (m = null), (p = z), (g = !1);
...
function qu(e, n, t, r) {
  if (Ir) {
    var l = cu(e, n, t, r);
    if (l === null) Dl(e, n, r, jr, t), Yo(e, r);
...
function hn() {
  if (!jl && Ae !== null) {
    ...
    try {
      ...
      throw (Ae !== null && (Ae = Ae.slice(e + 1)), Cs(Xu, hn), l);
    } finally {
      (O = n), (jl = !1);
    }
  }
...
function No() {
  (Y === 0 || Y === 3 || Y === 2) && (Y = 4),
    J === null || (!(Ln & 268435455) && !(cl & 268435455)) || be(J, b);
}
function qr(e, n) {
  var t = R;
  R |= 2;
  ...
  switch (e.tag) {
    case 3:
      ...
      if (n.current.memoizedState.isDehydrated) {
        ...
        t !== 0 &&
          (Zu(n, t | 1), pe(n, W()), !(R & 6) && ((lt = W() + 500), hn()));
      }
      break;
    case 13:
      Tn(function () {
...
ys = xo;
gs = Tn;
var zd = { usingClientEntryPoint: !1, Events: [Jt, $n, ul, vs, hs, xo] },
  yt = {
...
const Rd = ({ onNewCategory: e }) => {
    const [n, t] = tn.useState(""),
      r = ({ target: u }) => {
        t(u.value);
      },
      l = (u) => {
        u.preventDefault(), !(n.trim().length <= 3) && (t(""), e(n.trim()));
      };
    return Z.jsx("form", {
      onSubmit: l,
  ...
  Od = ({ title: e, url: n, id: t }) =>
    Z.jsxs("div", {
      className: "card",
      children: [Z.jsx("img", { src: n, alt: e }), Z.jsx("p", { children: e })],
    }),
  Md = async (e) => {
    const n = `https://api.giphy.com/v1/gifs/search?api_key=jCCCiH98wjoBsy4whWt5YYBeohMiC3ip&q=${e}&limit=10`,
      t = await fetch(n),
      { data: r } = await t.json();
    return r.map((u) => ({
      id: u.id,
  ...
  Id = ({ category: e }) => {
    const { images: n, isLoading: t } = Dd(e);
    return Z.jsxs(Z.Fragment, {
      children: [
        Z.jsx("h3", { children: e }),
        t && Z.jsx("h2", { children: " cargando..." }),
        Z.jsx("div", {
          className: "card-grid",
          children: n.map((r) => Z.jsx(Od, { ...r }, r.id)),
        }),
      ],
    });
  },
  jd = () => {
    const [e, n] = tn.useState(["Messi"]),
      t = (r) => {
        e.includes(r) || n([r, ...e]);
      };
    return Z.jsxs(Z.Fragment, {
      children: [
        Z.jsx("h1", { children: "GifExpertApp" }),
        Z.jsx(Rd, { onNewCategory: (r) => t(r) }),
        e.map((r) => Z.jsx(Id, { category: r }, r)),
      ],
    });
  };
Ql.createRoot(document.getElementById("root")).render(
  Z.jsx(wc.StrictMode, { children: Z.jsx(jd, {}) })
);
